...
interface ManagedPartnerRow { partnerId: string; partnerName: string | null; contactName: string | null; phone: string | null; email: string | null; }
