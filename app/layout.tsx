...
export const metadata: Metadata = {
  metadataBase: new URL(APP_URL), title: "مسار | إدارة صيانة الهواتف", description: "مسار متكامل لإدارة صيانة الهواتف من الاستلام حتى التسليم", applicationName: "مسار", manifest: "/manifest.webmanifest",
  icons: { icon: [{ url: "/massar-pwa-192.png", sizes: "192x192", type: "image/png" }, { url: "/massar-pwa-512.png", sizes: "512x512", type: "image/png" }], apple: [{ url: "/massar-apple-touch.png", sizes: "180x180", type: "image/png" }] },
  appleWebApp: { capable: true, statusBarStyle: "default", title: "مسار" },
};
