 ...
 *
 * Important: this policy NEVER expires or blocks the lifetime core licence.
 * It only controls entitlement to support and future maintenance-gated features.
 * Security fixes and core corrective updates must not be placed behind this guard.
 */
