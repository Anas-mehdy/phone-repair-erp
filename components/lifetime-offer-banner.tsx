...
export function LifetimeOfferBanner({ remaining, total }: { remaining: number; total: number }) {
  return (
    <div className="sticky top-0 z-[60] border-b border-amber-300 bg-gradient-to-l from-amber-500 via-orange-500 to-amber-500 px-3 py-2 text-slate-950 shadow-md">
